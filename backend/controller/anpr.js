      ...
      history: [
        {
          ...
          parts: [
            ...
            {text: "Return the License Numbers of vehicles in the image(can also be text written on a white piece of paper) and give me the response as [License Plate 1, License Plate 2 ....]. In license plate numbers remove any whitespaces in between.\n NOTE: If there are no cars then return empty list like []\n"},
          ],
        },
      ],
    });
