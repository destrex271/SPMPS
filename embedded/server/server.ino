...
String sendRequest_Capture(String);
void handle_ShowDevices(AsyncWebServerRequest *);
...
void loop() {
  // Nothing to do here
  Serial.println("Capturing parking lot frame...");
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    Serial.printf("Sending next request in 5 seconds...");
    delay(loopDelay);
  }
}
